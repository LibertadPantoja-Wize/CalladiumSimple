...
\par
\nbvspace[0.5]
{\Huge \bfseries \nbtitlestretch Calladium} 
\noindent \textcolor{DeepPink3}{\rule{16cm}{0.5mm}}
\vfill
\noindent \textcolor{emerald}{\rule{16cm}{0.5mm}}
\\
\vskip\baselineskip
\noindent{\LARGE Sueños pandémicos}
\nbvspace[0.5]
\end{center}
...
\thispagestyle{empty}
~\vfill
\noindent \textsc{\textbf{Calladium. Sueños pandémicos}}\\ % Nombre
\\
